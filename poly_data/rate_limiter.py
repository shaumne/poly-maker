...
class RateLimiter:
    ...
    def __init__(self):
        ...
        self._rate_limits = {
            ...
            # CLOB API - Trading
            'clob_post_order': {'requests': 40, 'window_seconds': 1},  # Sustained: 40/s
            'clob_post_order_burst': {'requests': 240, 'window_seconds': 1},  # Burst: 240/s
            'clob_delete_order': {'requests': 40, 'window_seconds': 1},  # Sustained: 40/s
            'clob_delete_order_burst': {'requests': 240, 'window_seconds': 1},  # Burst: 240/s
            'clob_post_orders': {'requests': 20, 'window_seconds': 1},  # Sustained: 20/s
            'clob_delete_orders': {'requests': 20, 'window_seconds': 1},  # Sustained: 20/s
            'clob_cancel_all': {'requests': 5, 'window_seconds': 1},  # Sustained: 5/s
            ...
            'clob_ledger': {'requests': 300, 'window_seconds': 10},
